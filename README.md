...
Более подробно о работе всех перечисленных методов можно прочитать здесь (https://docs.python.org/3/reference/datamodel.html#emulating-numeric-types)
и здесь (https://docs.python.org/3/reference/datamodel.html#object.__eq__).
